  ...
  if(searchdata)
  {
    return (
      <div className="card-list">
            {searchdata.map((data) => {
              return <Link to={"/app/searched/"+data.idMeal} key={data.idMeal} className="list1"><Card {...data}/></Link>;
            })}
      </div>
    )
  }
    ...
    <div className="body">
      ...
      <div className="lower-body">
        ...
        <div className="food2">
            ...
            <div className="card-list">
            {randomdata.map((data) => {
                return <Link to={"/app/searched/"+data.idMeal} key={data.idMeal} className="list2"><Card {...data}/></Link>;
            })}
            </div>
        </div>
      </div>
